...
[`metric_analysis.qmd`](metric_analysis.qmd), where this sweep is included in
...
![Balking rate by class](../outputs/class1_balking/figures/balking_rate_by_class.png)

The balking-rate plot confirms that the mechanism is rejection of offered appointments after long waits. It should be interpreted as a diagnostic, not as a final access outcome.
