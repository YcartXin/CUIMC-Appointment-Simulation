...
Here, utilization means booked slots divided by available slots.
...
## Figures
- `figures/weighted_utilization_by_weight.png`
- `figures/weighted_offered_wait_by_weight.png`
- `figures/weighted_utilization_delta_vs_fcfs_by_weight.png`
