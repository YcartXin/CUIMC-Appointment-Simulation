...
# Classify and postprocess the completed release-only pilot.
#
# Usage:
#   ./jobs/finalize_h1_patient_characteristics_pilot.sh
...
RAW_ROOT="${PILOT_RAW_ROOT:-/scratch/$USER/h1_patient_characteristics_pilot}"
OUTPUT_ROOT="$REPO/full_run_summaries/h1_patient_characteristics_pilot"
...
echo "Pilot outputs written to: $OUTPUT_ROOT/release"
